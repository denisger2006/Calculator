...
#define MyAppPublisher "Geraskin Denis"
#define MyAppExeName "Math Calculator.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{64FAE6E0-F378-4440-B402-8B632DA55AF6}
AppName={#MyAppName}
...
SetupIconFile=C:\Users\Пользователь\Desktop\язык с#\Calculator\Math Calculator\calculator.ico
...
[Files]
Source: "C:\Users\Пользователь\Desktop\язык с#\Calculator\Math Calculator\bin\Release\net10.0-windows\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
